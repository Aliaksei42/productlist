            ...
            <table className={styles.table}>
                <thead>
                    <tr className={styles.borderTop}>
                        <th className={styles.headerCell} onClick={() => filterData('id')}>ID</th>
                        <th className={styles.headerCell} onClick={() => filterData('product')}>Name</th>
                        <th className={styles.headerCell} onClick={() => filterData('price')}>Price</th>
                        <th className={styles.headerCell} onClick={() => filterData('brand')}>Brand</th>
                    </tr>
                </thead>
                <tbody>
